...
public class PublicationController {
	...
	@PostMapping
	public ResponseEntity<Void> create(@AuthenticationPrincipal UserPrincipal user, @RequestBody CreatePublicationDto dto) {
		try {
			this.createPublicationUseCase.execute(user.getId(), dto);
